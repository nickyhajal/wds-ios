class ScheduleDaySelect < MK::Layout
  view :day_list
  def layout
    @_day_list = ScheduleTimeListing.new
...
class ScheduleTimeCell < ProMotion::CollectionViewCell
...
class ScheduleTimeListing < ProMotion::CollectionScreen
  title "ScheduleTimeListing"
  ...
  cell_classes cell: ScheduleTimeCell
