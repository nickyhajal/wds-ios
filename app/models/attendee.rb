class Attendee
  attr_accessor :user_id, :first_name, :last_name, :full_name, :ticket_type, :email, :user_name, :twitter, :instagram, :facebook, :pic, :location, :lat, :lon, :distance, :qnaStr, :isQna, :academy
  def initialize(atn)
    if atn == 'default'
      @first_name = '░░░░░░░░░'
      @last_name = '░░░░░░░░'
